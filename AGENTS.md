# fenum — agent instructions

Universal Forth containers (`ulist`, type-tag dispatcher in Elixir `Enum` style).
...
`project_root` = absolute path to **this** repo (e.g. `/home/sea/fenum`).
